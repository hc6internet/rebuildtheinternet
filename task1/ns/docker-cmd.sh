...
export PARAMS="--daemon=no --webserver=yes --api=yes --webserver-address=$PDNS_webserver_address --webserver-port=$PDNS_webserver_port --webserver-password=$PDNS_webserver_password --api-key=$PDNS_api_key"
